                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="amount" type="amount" class="form-control" name="amount" value="{{ old('amount') }}" required>
                        ...
                        <div class="col-md-6">
                            <input id="roles" type="roles" class="form-control" name="roles" value="{{ old('roles') }}" required>
